...
export const deleteLeadReducer = (state = postinitState, action) => {
  switch (action.type) {
    case leadConstants.GET_DELETE_LEAD_SUCCESS:
      state = {
        ...state,
        leads: action.payload.leads,
      };
...
export const logoutLeadReducer = (state = initState, action) => {
  switch (action.type) {
    case leadConstants.LOGOUT_LEAD_SUCCESS:
      state = {
        ...initState,
      };
      break;
